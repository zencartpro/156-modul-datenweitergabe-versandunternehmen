 ...
 * @version $Id: orders.php for Datenweitergabe an Versandunternehmen 2019-07-04 10:55:51Z webchills $
 */
...
// Sort Listing
		  ...
		  <td class="dataTableHeadingContent text-center">Zustimmung</td>
<?php
  // -----
...
?>
 <td class="dataTableContent text-center"><?php echo $orders->fields['carrier']; ?></td>              
<?php
  // -----
  // A watching observer can provide an associative array in the form:
  //
